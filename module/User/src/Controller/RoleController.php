...
class RoleController extends AbstractActionController 
{
    ...
    public function addAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if($form->isValid()) {
                ...
                // Add a flash message.
                $this->flashMessenger()->addSuccessMessage('Nuevo rol agregado.');
    ...
    public function editAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if($form->isValid()) {
                ...
                // Add a flash message.
                $this->flashMessenger()->addSuccessMessage('Se actualizó el rol.');
    ...
    public function editPermissionsAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if($form->isValid()) {
                ...
                // Add a flash message.
                $this->flashMessenger()->addSuccessMessage('Permisos actualizados para el rol.');
    ...
    public function deleteAction()
    {
        ...
        // Add a flash message.
        $this->flashMessenger()->addSuccessMessage('Eliminado el rol.');
