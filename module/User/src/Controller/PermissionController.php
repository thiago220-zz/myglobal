...
class PermissionController extends AbstractActionController 
{
    ...
    public function addAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if($form->isValid()) {
                ...
                // Add a flash message.
                $this->flashMessenger()->addSuccessMessage('Se agregó un nuevo permiso.');
    ...
    public function editAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if($form->isValid()) {
                ...
                // Add a flash message.
                $this->flashMessenger()->addSuccessMessage('Se actualizó el permiso.');
    ...
    public function deleteAction()
    {
        ...
        // Add a flash message.
        $this->flashMessenger()->addSuccessMessage('Eliminado el permiso.');
