...
class AuthManager
{
    ...
    {   
        ...
        if ($this->authService->getIdentity()!=null) {
            throw new \Exception('Ya iniciado sesión');
        }
    ...
    public function filterAccess($controllerName, $actionName)
    {
        ...
        if ($mode!='restrictive' && $mode!='permissive')
            throw new \Exception('Modo de filtro de acceso no válido (esperado modo restrictivo o permisivo)');
            ...
            foreach ($items as $item) {
                ...
                if (is_array($actionList) && in_array($actionName, $actionList) ||
                    ...
                    if ($allow=='@') {
                        ...
                        throw new \Exception('Valor inesperado para "allow" - esperado '.
                                'o "?", "@", "@identity" o "+ "+permission"');
                    }
                }
            }            
        }
